...
# class sample(absparam):  # TODO: finish. too complicated to implement a dependence tree able to unevaluate all related lazyvals. would also add overhead to any hdict creation.
#     """
